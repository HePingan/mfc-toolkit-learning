...
export const evidenceTypes: Array<'全部' | EvidenceType> = [
  '全部',
  '截图',
  '日志',
  '源码',
...
export const evidenceTemplate: EvidenceItem[] = [
  {
    ...
    module: '交付',
    path: '',
    note: '项目目标、技术栈、功能模块、个人贡献、边界说明。',
    status: 'missing',
    linkedSubmitIds: ['readme'],
  },
  {
    id: 'source-tree-shot',
    title: '源码目录截图',
    ...
    module: '源码',
    path: '',
    note: 'MfcToolkitDlg、SerialManager、TcpClient、HttpClient、ConfigStore、Logger、WorkerThread。',
    status: 'missing',
    linkedSubmitIds: ['source-tree'],
  },
  {
    id: 'vs-build-success',
    ...
    module: '构建',
    path: '',
    note: 'Debug/Release x64 生成成功输出。',
    status: 'missing',
    linkedSubmitIds: ['vs-build'],
  },
  {
    id: 'main-dialog-run',
    title: '主 Dialog 运行截图',
    ...
    module: 'MFC UI',
    path: '',
    note: '主窗口、Tab、参数区、发送区、日志区。',
    status: 'missing',
    linkedSubmitIds: ['main-dialog'],
  },
  {
    id: 'serial-log',
    title: '串口收发日志',
    ...
    module: '串口',
    path: '',
    note: 'COM 参数、ASCII/HEX 发送、接收日志、异常提示。',
    status: 'missing',
    linkedSubmitIds: ['serial-tcp-http'],
  },
  {
    id: 'tcp-log',
    title: 'TCP 连接/断开日志',
  ...
  },
  {
    ...
    module: 'HTTP',
    path: '',
    note: 'GET/POST、Header、Body、状态码、响应内容。',
    status: 'missing',
    linkedSubmitIds: ['serial-tcp-http'],
  },
  {
  ...
  },
  {
    ...
    module: '演示',
    path: '',
    note: '3/5/10 分钟讲解稿和彩排记录。',
    status: 'missing',
    linkedSubmitIds: ['demo-script'],
  },
  {
    id: 'defense-record-md',
    title: '答辩训练记录',
    type: 'Markdown',
    module: '答辩',
    path: '',
    note: '问答记录、证据链接、未掌握问题补强。',
    status: 'missing',
    linkedSubmitIds: ['defense-record'],
  },
];

export function normalizeEvidence(items: EvidenceItem[]) {
  return evidenceTemplate.map((template) => ({
    ...template,
