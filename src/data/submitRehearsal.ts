...
export const submitEvidenceTemplate: SubmitEvidenceItem[] = [
  {
    ...
    title: 'README 项目说明',
    route: '/portfolio',
    required: '项目目标、技术栈、模块清单、个人贡献、运行边界',
    proof: 'README.md、项目截图、作品集导出',
    status: 'missing',
    note: '',
  },
  {
    ...
    title: '源码目录与关键文件',
    route: '/codegen',
    required: 'Dialog、通讯、数据、日志、线程模块能对应到 .h/.cpp',
    proof: '工程目录截图、关键文件路径、代码骨架 ZIP',
    status: 'missing',
    note: '',
  },
  {
    id: 'vs-build',
    title: 'Visual Studio 编译截图',
    route: '/build-checklist',
    required: 'Windows + Visual Studio + MFC 本地生成成功',
    proof: 'Debug/Release x64 生成成功输出、主工程配置截图',
    status: 'missing',
    note: '',
  },
  {
    ...
    title: '主界面运行截图',
    route: '/designer',
    required: 'MFC Dialog 主窗口、Tab/按钮/日志区可见',
    proof: '主 Dialog 运行截图、控件 ID 表、事件绑定截图',
    status: 'missing',
    note: '',
  },
  {
    id: 'serial-tcp-http',
    title: '串口 / TCP / HTTP 日志',
    route: '/integration',
    required: '核心通讯链路至少各有一条收发或请求响应证据',
    proof: '串口收发、TCP 连接断开、HTTP GET/POST 响应日志',
    status: 'missing',
    note: '',
  },
  {
    id: 'sqlite-ini',
    title: 'SQLite / INI 持久化证据',
    route: '/practice',
    required: '参数保存、重启恢复、历史记录或设备表可证明',
    proof: 'app.ini、SQLite 表结构、重启后参数恢复截图',
    status: 'missing',
    note: '',
  },
  {
    ...
    title: '项目演示稿',
    route: '/demo-script',
    required: '3/5/10 分钟演示流程和每步证据路径',
    proof: 'mfc-demo-script.md、彩排记录、截图列表',
    status: 'missing',
    note: '',
  },
  {
    ...
    title: '答辩训练记录',
    route: '/exam',
    required: '能解释技术选型、工程边界、常见追问和验收证据',
    proof: 'mfc-exam-defense-drills.md、问答记录、未掌握问题补强计划',
    status: 'missing',
    note: '',
  },
];
